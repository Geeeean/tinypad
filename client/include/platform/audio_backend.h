...
//   - src/platform/audio/audio_macos_stub.c       (no-op: reports zero
//     sessions until a Core Audio backend is written)
...
typedef struct {
    ...
    // ~30-60Hz; backends with nothing to poll (the macOS stub) return
    // immediately.
